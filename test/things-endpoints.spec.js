  ...
  describe('GET /api/things', () => {
    ...
    context('Given there are things in the database', () => {
      ...
      it('responds with 200 and all of the things', () => {
        const expectedThings = testThings.map((thing) => helpers.makeExpectedThing(testUsers, thing, testReviews));
    ...
    context('Given an XSS attack thing', () => {
      ...
      it('removes XSS attack content', () => {
        return supertest(app).get('/api/things').expect(200).expect((res) => {
  ...
  describe('GET /api/things/:thing_id/reviews', () => {
    ...
    context('Given there are reviews for thing in the database', () => {
      ...
      it('responds with 200 and the specified reviews', () => {
        const thingId = 1;
        const expectedReviews = helpers.makeExpectedThingReviews(testUsers, thingId, testReviews);
